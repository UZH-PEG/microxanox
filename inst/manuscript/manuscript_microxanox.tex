...
\href{https://uzh-peg.r-universe.dev/articles/microxanox/User-guide.html}{Usert
Manual} \\
...
the supplement \citep{Petchey2022} to \citet{Limberger2022} for an
example of how this is used). As such, all the parameters needed to run
a simulation or find a stable state (i.e.~the final state of the
...
{\centering \includegraphics[width=350px]{/Users/rainer/git/0.RPackages/microxanox/inst/manuscript/figures/gen_uc1_partrep_temporal_state_switching} 
...
{\centering \includegraphics[width=150px]{/Users/rainer/git/0.RPackages/microxanox/inst/manuscript/figures/gen_uc2_user_guide_hysteresis} 
