...
Here make an overview of how conditions and parameters are specified, stored, and results stored. I think there is text in the user guide vignette that can be used (duplicated) here.
...
**Please include figures so they can have captions and be cross referenced, as in the Supplement.**
