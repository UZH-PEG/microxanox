...
Give a short overview of the overall software architecture; provide a pic- torial component overview or similar (if possible). If necessary provide im- plementation details.
...
Optional: you may include one explanatory video that will appear next to your article, in the right hand side panel.
...
# THIS NEEDS TO BE TRANSFERED IN THE FORMAT ABOVE
...
<span style="color:red">{>> Add a more detailed description of the model and the additions <<}
{>>TODO<<}</span>
...
<span style="color:green">{>>If we want that, we have to include some, even rudimentary, GITHUB tests.<<}
...
```{r user_guide_hysteresis, echo = FALSE,  include=TRUE, fig.cap='Hysteresis of all assessed combinations of variability.', fig.align="center", out.width = 500 }
