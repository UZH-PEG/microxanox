...
```{plantuml runsim_example, eval = TRUE, plantuml.format = "auto", plantuml.preview = TRUE}
@startuml
...
We will now discuss the general structure and functionality of the package without going into to much detail. A more detailed discussion can be found in the [User Guide](LINK_NEEDED).
