...
get_ssbyaN_parameter <- function(result, i) {
  ...
  CBs <- unlist(rep(
    parameter$ss_expt[i, ]["N_CB"] / length(grep("CB", names(parameter$strain_parameter$initial_state))),
  ...
  PBs <- unlist(rep(
    parameter$ss_expt[i, ]["N_PB"] / length(grep("PB", names(parameter$strain_parameter$initial_state))),
  ...
  SBs <- unlist(rep(
    parameter$ss_expt[i, ]["N_SB"] / length(grep("SB", names(parameter$strain_parameter$initial_state))),
