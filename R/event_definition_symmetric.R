...
#' @param log10aO_forcing_func function to change oxygen diffusivity `aO`
#'   depending on `t`
#' @param log10aS_forcing_func function. to change sulfide diffusivity `aS` 
#'    depending on `t` 
...
#' @md
#' @export
event_definition_symmetric <- function(
    times,
    state,
    parms,
