...
## 1 strain (though with multistrain functions)
...
## 3 strain (though with multistrain functions)

```{r sim_ss_CB_SB_PB3, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_CB_SB_PB.Rds")}
