...
The microxanox package may be update / changed, so please take care to work with a specific version. This user guide is working with version 0.3.0, and the loaded version is:
