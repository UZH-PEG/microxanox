...
We also include functions for visualising results, though *please note that these plotting functions are provided for convenience, and not for production of perfectly formatted print-ready graphs.*
