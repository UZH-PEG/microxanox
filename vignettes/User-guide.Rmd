...
We now assyume, that an empty parameter set has been created by using
...
bush_anoxicstart_1strain <- new_strain_parameter(n_CB = 1,
                                        values_CB = "bush",
                                        n_PB = 1,
                                        values_PB = "bush",
                                        n_SB = 1,
...
```{r}
bush_oxicstart_1strain <- new_strain_parameter(values_initial_state = "bush_oxic_fig2cd")
```
