...
default_log10a_series <- c(log10(new_strain_starter()[["a_O"]]),
                           log10(new_strain_starter()[["a_O"]]))
...
```{r}
one_strain_paramameter <- new_strain_starter()
...
```{r}
multi_strain_paramameter <- new_strain_starter(n_CB = 3, n_PB = 3, n_SB = 3)
