...
sim_res <- run_simulation(initial_state = new_initial_state(values = "bush_anoxic_fig2ab"))
...
sim_res <- run_simulation(initial_state = new_initial_state(values = "bush_oxic_fig2cd"))
...
### Next part not working... also need to check again the user guide
