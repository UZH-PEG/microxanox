...
Much of the code used to create the content of this vignette is not shown in the rendered (pdf or html) document. It is available in the [microxanox github repository](https://github.com/opetchey/microxanox/blob/main/vignettes/partial-reproduction-Bushetal2017.Rmd)
...
sim_res <- run_simulation(parameter)
saveRDS(sim_res, file = "data/partial_reproduction/bush_oxic_fig2cd.RDS")
...
saveRDS(sim_res, file = "data/partial_reproduction/parameter_ss_CB_SB_PB.RDS")
...
```{r echo = FALSE, sim_ss_no_biology, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_no_biology.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_CB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_CB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_SB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_SB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_PB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_PB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_SB_PB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_SB_PB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_SB_CB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_SB_CB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_only_CB_PB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_only_CB_PB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
...
```{r echo = FALSE, sim_ss_CB_SB_PB, eval = run_steadystate_sims | !file.exists("data/partial_reproduction/ss_CB_SB_PB.RDS")}
grid_num_a <- 100
grid_num_N <- 2
