...
These additional results are only presented graphically below, and are not discussed. Some will be presented and discussed in an article associated with this package (*link to be added*).
...
initial_PBs <- 1e8
initial_SBs <- 1e8
parameter$ss_expt <- expand.grid(N_CB = initial_CBs,
                    N_PB = initial_PBs,
                    N_SB = initial_SBs,
                    a_O = a_Os)

ss_CB_SB_PB <- ss_by_a_N(parameter)
```
...
## run simulation
sim_res <- run_simulation(dynamic_model = bushplus_dynamic_model,
                          initial_state = new_initial_state(values = "bush_oxic_fig2cd"), # init_state_favouring_oxic,
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    N_SB = initial_SBs,
                    a_O = a_Os)
ss_no_biology <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    N_SB = initial_SBs,
                    a_O = a_Os)
ss_only_CB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    N_SB = initial_SBs,
                    a_O = a_Os)
ss_only_SB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    N_SB = initial_SBs,
                    a_O = a_Os)
ss_only_PB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    a_O = a_Os)
expt$N_SB <- expt$N_PB
ss_only_SB_PB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    a_O = a_Os)
#expt$N_SB <- expt$N_CB
ss_only_SB_CB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    a_O = a_Os)
expt$N_CB <- expt$N_PB
ss_only_CB_PB <- ss_by_a_N(expt, ssfind_parameters)
```
...
expt <- expand.grid(N_CB = initial_CBs,
                    ...
                    N_SB = initial_SBs,
                    a_O = a_Os)
ss_CB_SB_PB <- ss_by_a_N(expt, ssfind_parameters)
```
...
stab_res <- all_ss %>%
  ...
  gather(key = "stab_measure", value = "value", 3:8)
