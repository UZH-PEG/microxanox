...
mdat <- function(name = "") {
  system.file(file.path("doc", "data", "partial_reproduction", name), package = "microxanox")
}

##########
### To generate the data, please uncomment the following three lines 
# and create the directory 
# 
mdat <- function(name = "") {
  file.path(".", "data", "partial_reproduction", name)
}
...
stab_res <- all_ss %>%
  ...
  do(stab_measures = get_stability_measures_temporal_ssfind_result(.)) %>%
